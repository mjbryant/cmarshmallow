...
from cmarshmallow.compat import text_type, iteritems
from cmarshmallow.exceptions import (
    ValidationError,
)
...
class ErrorStore(object):
    ...
    def call_and_store(self, getter_func, data, field_name, field_obj, index=None):
        ...
        :param int index: Index of the item being validated, if validating a collection,
            otherwise `None`.
        """
        # The marshaller tries to serialize the field using field.serialize.
        try:
